<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ErrorPage.aspx.cs" Inherits="BEC.ErrorPage" %>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles"  >Error de conexion </h1>
            </div>
        </div>
        ...
        <form autocomplete="off" runat="server">
            ...
            <h2 align="center"> No se ha podido establecer una conexion con la base de datos</h2>

            <br />
            <p style="text-align:center">
<asp:Image ID="imgError" runat="server" Height="110px" ImageUrl="~/assets/img/caraError.jpg" Width="206px" />
                </p>
