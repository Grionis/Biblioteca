<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="searchbook.aspx.cs" Inherits="BEC.searchbook" %>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <div class="navbar-lateral full-reset">
        ...
        <div class="full-reset container-menu-movile custom-scroll-containers">
            ...
            <div class="full-reset" style="background-color:#2B3D51; padding: 10px 0; color:#fff;">
                <figure>
                   <a href="catalogoEstudiantes.aspx" > <img src="assets/img/logo.png" alt="Biblioteca" class="img-responsive center-box" style="width:55%;"></a>
                </figure>
...
<asp:Button ID="btnVolver" runat="server" Text="Volver a Catalogo" class="btn btn-primary" OnClick="btnVolver_Click" /> 
           </div>
        <br><br><br>
        <h3 class="text-center all-tittles">resultados de la búsqueda</h3>
        <p class="text-center all-tittles">&nbsp;</p>
        <p class="text-center all-tittles">
            <asp:GridView ID="gvLibro" runat="server" class="table" OnSelectedIndexChanged="gvLibro_SelectedIndexChanged1" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" >
            ...
            <asp:GridView ID="gvMultimedia" runat="server" class="table" />
    <asp:Label ID="lblAlert" runat="server" Text=" Lo sentimos, no hemos encontrado ningún libro con el nombre ingresado en el sistema" ></asp:Label>
