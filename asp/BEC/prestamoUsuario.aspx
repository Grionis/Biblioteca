<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="prestamoUsuario.aspx.cs" Inherits="BEC.prestamoUsuario" %>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
         ...
         <div class="conteiner-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation"  ><a href="informacionUsuario.aspx">Informacion</a></li>
                 <li role="presentation"  class="active"><a href="prestamoUsuario.aspx">Ver Prestamos</a></li>
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Ver mis prestamos</div>
                <form autocomplete="off" runat ="server">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           <legend>Prestamos activos<br><br>
