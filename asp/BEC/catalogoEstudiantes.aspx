<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="catalogoEstudiantes.aspx.cs" Inherits="BEC.scripts.catalogoEstudiantes" %>
         ...
         <div class="container-fluid"  style="margin: 40px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido al catálogo, Elije un Libro o Multimedia de la lista para empezar, recuerda que para poder realizar un prestamo o una reserva es necesario registarse o iniciar sesion con sus datos de acceso.
                </div>
            </div>
        </div>
        <form autocomplete="off" runat="server">
            <div style="text-align:center">
<asp:Button ID="btnIniciar" runat="server" Text="Iniciar Sesion" class="btn btn-primary" OnClick="btnIniciar_Click"  /> &nbsp&nbsp&nbsp&nbsp <asp:Button ID="btnRegistrse" runat="server" Text="Registrarse" class="btn btn-primary" OnClick="btnRegistrse_Click" />
           </div>
                <br />
