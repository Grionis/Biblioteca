<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comprobante.aspx.cs" Inherits="BEC.comprobante" %>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema bibliotecario <small>Comprobante
                                                            </small></h1>
            </div>
        </div>
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Sección en la cual podra imprimir su comprobante
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <form autocomplete="off" runat="server">
                    ...
                    <div class="title-flat-form title-flat-blue">Comprobante</div>
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <strong>Información de Comprobante</strong><br>

                         

                         
                         <div class="group-material">
                              <asp:TextBox ID="txtTipo" runat="server"  class="tooltips-general material-control" ReadOnly="True"></asp:TextBox>
                           ...
                           <div class="group-material">
                               ...
                               <asp:TextBox ID="txtEstado" runat="server" class="tooltips-general material-control"  required="" ReadOnly="True"></asp:TextBox> 
                                <span class="highlight"></span>
                                <span class="bar"></span>
                           ...
                           <div class="group-material">
                                ...
                                <asp:TextBox ID="txtFechaPrestamo" runat="server" class="tooltips-general material-control"  required="" ReadOnly="True"></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                              <asp:Label ID="lblFechaPrestamo" runat="server" Text="">Fecha de Prestamo</asp:Label>
                            </div>
                            <div class="group-material">

                                <asp:TextBox ID="txtFechaDevolución" runat="server" class="tooltips-general material-control"  required="" ReadOnly="True"></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                              <asp:Label ID="lblFechaDevolución" runat="server" Text="">Fecha de Devolución</asp:Label>
                            </div>
