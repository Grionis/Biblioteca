<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActualizarClave.aspx.cs" Inherits="BEC.ActualizarClave" %>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema bibliotecario <small>Registro</small></h1>
            </div>
        </div>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección de cambio de clave, para poder cambiar su clave de acceso, debera completar el formulario
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Cambiar Clave de Acceso</div>
                <form autocomplete="off" runat ="server">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           <legend>Credenciales<br><br></legend>
                            
                            <div class="group-material">
                                <asp:TextBox ID="txtPass1" runat="server" class="material-control tooltips-general"  placeholder="Ingrese la contraseña" required="" maxlength="30" TextMode="Password" data-toggle="tooltip" data-placement="top" title="Clave de usuario" ></asp:TextBox>
                            ...
                            <div class="group-material">
                                <asp:TextBox ID="txtPass2" runat="server" class="material-control tooltips-general"  placeholder="Vuelva a ingresar la contraseña" required="" maxlength="30" TextMode="Password" data-toggle="tooltip" data-placement="top" title="Clave de usuario" ></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <p class="text-center">
                                ...
                                <asp:Button ID="btnGuardar" runat="server" Text="Cambiar Clave"  class="btn btn-primary" OnClick="btnGuardar_Click" />
