<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="loan.aspx.cs" Inherits="BEC.loan" %>
...
<asp:GridView ID="gvPrestamoMulti" runat="server" HorizontalAlign="Center" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" class="table" AllowPaging="True" OnPageIndexChanging="gvPrestamoMulti_PageIndexChanging1" OnSelectedIndexChanged="gvLibros_SelectedIndexChanged" PageSize="7" OnSorted="gvLibros_Sorted">
        <AlternatingRowStyle BackColor="#DCDCDC" />
        <FooterStyle BackColor="#CCCCCC" ForeColor="Black" />
        <HeaderStyle BackColor="#000084" Font-Bold="True" ForeColor="White" />
        <PagerStyle BackColor="#999999" ForeColor="Black" HorizontalAlign="Center" />
