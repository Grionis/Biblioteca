<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="eliminarUsuario.aspx.cs" Inherits="BEC.eliminarUsuario" %>
        ...
        <div class="container-fluid">
            <form autocomplete="off" runat="server">
                <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Eliminar Usuario</div>
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           <p class="text-center">
                            <legend><strong>Ingrese usuario a eliminar</strong></legend><br>
                            
                            <div class="group-material">
                                
                                <asp:TextBox ID="txtBusqueda" runat="server" class="tooltips-general material-control" placeholder="Escribe aquí el código correlativo del libro" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Escribe el código correlativo del libro, solamente números" Width="648px" OnTextChanged="txtIsbn_TextChanged"></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Nick del usuario</label>
                                <asp:Button ID="btnBuscar" runat="server" Text="Buscar Usuario" class="btn btn-primary" OnClick="btnGuardar_Click"  />
                            </div> <br />   

                           <asp:GridView ID="gvUsuario" runat="server" HorizontalAlign="Center" Width="593px" AllowPaging="True"></asp:GridView>
