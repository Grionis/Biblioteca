<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="multimedia.aspx.cs" Inherits="BEC.multimedia" %>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema bibliotecario <small>Multimedia</small></h1>
            </div>
        </div>
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para agregar nuevo contenido multimedia a la biblioteca, deberas de llenar todos los campos para poder registrar el libro
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <form autocomplete="off" runat="server">
                <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Nuevo Multimedia</div>
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <legend><strong>Información básica</strong></legend><br>

                            <div class="group-material">
                            <asp:DropDownList ID="ddlTipoMultimedia" runat="server" class="tooltips-general material-control"></asp:DropDownList>   
                        <%-- <asp:TextBox ID="txtTipo" runat="server" class="tooltips-general material-control" placeholder="Escribe aquí el código correlativo del libro" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Escribe el tipo de multimedia"></asp:TextBox>--%>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                              <asp:Label ID="lblTipo" runat="server">Tipo Multimedia</asp:Label>  
                            </div>
                            <div class="group-material">
                            ...
                            <div class="group-material">
                                ...
                                <asp:TextBox ID="txtTitulo" runat="server" class="tooltips-general material-control" placeholder="Escribe aquí el título o nombre del Multimedia" required="" maxlength="70" data-toggle="tooltip" data-placement="top" title="Escribe el título o nombre del Multimedia"></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Título</label>
                            </div>
                            <div class="group-material">
                                ...
                                <asp:TextBox ID="txtAutor" runat="server" class="tooltips-general material-control" placeholder="Escribe aquí el autor del Multimedia" required="" maxlength="70" data-toggle="tooltip" data-placement="top" title="Escribe el nombre del autor del Multimedia"></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Autor</label>
                            </div>
                           ...
                           <div class="group-material">
                                ...
                                <asp:TextBox ID="txtAño" runat="server" class="material-control tooltips-general" placeholder="Escribe aquí el año del Multimedia" required="" pattern="[0-9]{1,4}" maxlength="4" data-toggle="tooltip" data-placement="top" title="Solamente números, sin espacios" ></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Año</label>
                           </div>
                            ...
                            <div class="group-material">
                                ...
                                <asp:TextBox ID="txtStock" runat="server" class="material-control tooltips-general" placeholder="Escribe aquí la cantidad de Multimedias que registraras" required=" " pattern="[1-9]{1,7}" maxlength="7" data-toggle="tooltip" data-placement="top" title="¿Cuántos Multimedias registraras?" > </asp:TextBox>
                            ...
                            <div class="group-material">
                                ...
                                <asp:TextBox ID="txtPiso" runat="server" class="material-control tooltips-general" placeholder="Escribe aquí la ubicación del Multimedia" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="¿Dónde se ubicara el Multimedia?"></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Piso</label>
                            </div>
                                ...
                                <asp:TextBox ID="txtEstante" runat="server" class="material-control tooltips-general" placeholder="Escribe aquí la ubicación del Multimedia" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="¿Dónde se ubicara el Multimedia?"></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Estante</label>
                            </div>
