<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listadmin.aspx.cs" Inherits="BEC.listadmin" %>
...
<%--                            <li><a href="teacher.aspx"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i>&nbsp;&nbsp; Nuevo docente</a></li>--%>
       ...
       <%-- <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección donde se encuentra el listado de los Usuarios
                </div>
            </div>
        </div>--%>
    ...
    <asp:GridView ID="gvUsuarios" runat="server" HorizontalAlign="Center" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" class="table table-hover text-center">
