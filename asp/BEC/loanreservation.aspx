<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="loanreservation.aspx.cs" Inherits="BEC.loanreservation" %>
         ...
         <div class="container-fluid" style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a esta sección, aquí podras realizar reserva de tus libros o multimedias
                </div>
            </div>
        </div>
           ...
           <div class="container-fluid">
            <form autocomplete="off" runat="server">
               <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Nueva Reservacion</div>
                    <div class="row">
                   ...
                   <%--      
                            <div class="group-material">
                                  <asp:DropDownList ID="ddlUsuario" runat="server" class="tooltips-general material-control"></asp:DropDownList>
...
<asp:TextBox ID="idUsuario" runat="server"></asp:TextBox>
                         ...
                         <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>--%>
                           ...
                           <br />
                         <asp:Button ID="btnAceptar" runat="server" Text="Aceptar" class="btn btn-primary" OnClick="btnAceptar_Click1"/>
                           <div class="group-material">
                         ...
                         <asp:Label ID="lblLibro" runat="server" Text="">Libro</asp:Label>
                               <asp:Label ID="lblMultimedia" runat="server" Text="">Multimedia</asp:Label>
                           </div>
                           <div class="group-material">
                                  <asp:DropDownList ID="ddlUsuario" runat="server" class="tooltips-general material-control"></asp:DropDownList>
                                 <span class="highlight"></span>
                           ...
                           <div class="group-material">
                                ...
                                <span class="highlight"></span>
                                <span class="bar"></span>
                              <asp:Label ID="lblFechaReserva" runat="server" Text="">Fecha Reserva</asp:Label>
                            </div>
                            <%--<div class="group-material">
                                ...
                                <span class="highlight"></span>
                                <span class="bar"></span>
                              <asp:Label ID="lblFechaDevolución" runat="server" Text="">Hora de Devolución</asp:Label>
                            </div>--%>
