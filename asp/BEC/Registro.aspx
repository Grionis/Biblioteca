<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registro.aspx.cs" Inherits="BEC.Registro" %>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección de registro, para poder registrarse deberás llenar todos los campos del siguiente formulario
                </div>
            </div>
        </div>
                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           <legend>Datos Personales<br><br>
                            <div class="group-material">
                                ...
                                <asp:TextBox ID="txtRut" runat="server" class="material-control tooltips-general" placeholder="Escribe aquí el Rut del Usuario" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Rut De usuario" OnTextChanged="txtRut_TextChanged" AutoPostBack="True" ></asp:TextBox> 
