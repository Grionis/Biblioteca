<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student.aspx.cs" Inherits="BEC.student" %>
                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           <legend>Datos Personales<br><br>
                            <div class="group-material">
                                ...
                                <asp:TextBox ID="txtRut" runat="server" class="material-control tooltips-general" placeholder="Escribe aquí el Rut del Usuario" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Rut De usuario" AutoPostBack="True" OnTextChanged="txtRut_TextChanged" ></asp:TextBox>
                            ...
                            <div class="group-material">
                                <asp:TextBox ID="txtEmail" runat="server" TextMode="Email" class="material-control tooltips-general" placeholder="Escribe aquí el Email del Usuario" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Email De usuario" ></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Email</label>
                            </div>
                           ...
                           <%-- <div class="group-material">
                            ...
                            <div class="group-material">
                                <asp:TextBox ID="txtPass1" runat="server" TextMode="Password" class="material-control tooltips-general" placeholder="Ingrese la contraseña" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Clave de usuario" ></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
