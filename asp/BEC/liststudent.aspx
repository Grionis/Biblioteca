<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="liststudent.aspx.cs" Inherits="BEC.liststudent" %>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <%--<div class="container-fluid"  style="margin: 50px 0;">
         ...
         <h2 class="text-center all-tittles">listado de estudiantes</h2>
            ...
            <asp:GridView ID="gvUsuario" runat="server" HorizontalAlign="Center" Width="593px" AllowPaging="True" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" class="table" OnPageIndexChanging="gvUsuario_PageIndexChanging" >
        ...
        <footer class="footer full-reset">
            ...
            <div class="footer-copyright full-reset all-tittles">© 2016 MFC</div>
        </footer>
    </div>
