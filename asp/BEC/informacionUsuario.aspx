<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="informacionUsuario.aspx.cs" Inherits="BEC.informacionUsuario" %>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="conteiner-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation"  class="active" ><a href="informacionUsuario.aspx">Informacion</a></li>
                 <li role="presentation"><a href="prestamoUsuario.aspx">Ver Prestamos</a></li>
                 <li role="presentation"><a href="verUsuario.aspx"> Ver multas</a></li>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para ver la informacion de usuario
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Informacion de usuario</div>
                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           <legend>Datos Personales<br><br>
                               ...
                               <div class="group-material">
                                ...
                                <asp:Image ID="imgUser" runat="server" class="img-responsive center-box" />
...
<asp:Button ID="btnLimpiar" runat="server" Text="Limpiar campos" class="btn btn-info" style="margin-right:" OnClick="btnLimpiar_Click" />
&nbsp;&nbsp;
<asp:Button ID="btnActualizar" runat="server" Text="Actualizar informacion" class="btn btn-info" style="margin-right:"/>
