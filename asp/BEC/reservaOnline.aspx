<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reservaOnline.aspx.cs" Inherits="BEC.reservaOnline" %>
                ...
                <ul class="list-unstyled">
                   <%-- <li><a href="home.aspx"><i class="zmdi zmdi-home zmdi-hc-fw"></i>&nbsp;&nbsp; Inicio</a></li>
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled">
                            <li> <a href="prestamoOnline.aspx"><i class="zmdi zmdi-time-restore zmdi-hc-fw"></i>&nbsp;&nbsp; Nuevo Prestamo  <span class="label label-danger pull-right label-mhover"></span></a></li>
                           <%--  <li><a href="loan.aspx"><i class="zmdi zmdi-calendar zmdi-hc-fw"></i>&nbsp;&nbsp; Todos los préstamos</a></li>
                            ...
                            <li>
                                <a href="reservaOnline.aspx"><i class="zmdi zmdi-timer zmdi-hc-fw"></i>&nbsp;&nbsp; Reservaciones <span class="label label-danger pull-right label-mhover"></span></a>
                            </li>
                        </ul>
                    </li>
         ...
         <div class="container-fluid" style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a esta sección, aquí podrá realizar sus reservaciones de Libros o Multimedia
                </div>
            </div>
        </div>
                ...
                <div class="container-flat-form">
                    ...
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <label runat="server" id ="lblUser">Usuario</label>
                           ...
                           <label runat="server" id ="lblPass">Clave</label>
                            <div class="group-material">
                        ...
                        <asp:TextBox ID="idUsuario" runat="server"></asp:TextBox>
                         ...
                         <br /><br />
                           ...
                           <div class="group-material">
                              <asp:DropDownList ID="ddlTipo" runat="server" class="tooltips-general material-control"></asp:DropDownList>
                        ...
                        <asp:Button ID="btnAceptar" runat="server" Text="Aceptar" class="btn btn-primary" OnClick="btnAceptar_Click" />
                           ...
                           <label runat="server" id ="labelMultimedia">Mutlmedia</label>
                             <div class="group-material">
                               <asp:DropDownList ID="ddlLibro" runat="server" class="tooltips-general material-control"></asp:DropDownList>
                                <asp:DropDownList ID="ddlMultimedia" runat="server" class="tooltips-general material-control"></asp:DropDownList>
                                 <span class="highlight"></span>
                                <span class="bar"></span>
                           ...
                           <label runat="server" id ="labelFechReserva">Fecha de reserva</label>
                           <div class="group-material">
                             <%-- <asp:Calendar ID="cfechaReserva" runat="server" class="tooltips-general material-control" BackColor="White" BorderColor="White" BorderWidth="1px" Font-Names="Verdana" Font-Size="9pt" ForeColor="Black" Height="190px" NextPrevFormat="FullMonth" Width="350px">
                                ...
                                <asp:TextBox ID="txtFechaPrestamo" runat="server" class="tooltips-general material-control" placeholder="Escribe aquí Fecha de Prestamo" required="" TextMode="Date"></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
