<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="prestamo.aspx.cs" Inherits="BEC.Prestamo" %>
...
<%--                            <li><a href="teacher.aspx"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i>&nbsp;&nbsp; Nuevo docente</a></li>--%>
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled">
                             ...
                             <li><a href="prestamo.aspx"><i class="zmdi zmdi-time-restore zmdi-hc-fw"></i>&nbsp;&nbsp; Nuevo Prestamo  <span class="label label-danger pull-right label-mhover"> 1</span></a></li>
                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <legend><strong>Información básica</strong></legend><br>
                             ...
                             <div class="group-material">
                                ...
                                <asp:TextBox ID="txtUser" runat="server" class="tooltips-general material-control" placeholder="Escribe aquí el nombre de usuario" pattern="[0-9]{1,20}" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Escribe el nombre de usuario para el prestamo."></asp:TextBox>
                            
                                  <asp:TextBox ID="txtValidacion" runat="server" class="tooltips-general material-control" placeholder="Se mostrara si al usuario se le puede hacer un prestamo"></asp:TextBox>
                                      <asp:Button ID="btnValidar" runat="server" Text="Validar Usuario" class="btn btn-info " />
                           ...
                           <div class="group-material">
                                ...
                                <asp:TextBox ID="txtEstado" runat="server" class="tooltips-general material-control" placeholder="Se puede ver el estado del usuario" pattern="[0-9]{1,20}" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Se lee si el usuario puede o no realizar prestamos." ReadOnly="True"></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Estado </label>
                            </div>
                           ...
                           <div class="group-material">
                                ...
                                <asp:TextBox ID="ddlTipo" runat="server" class="tooltips-general material-control" placeholder="Escribe aquí el código correlativo del libro" pattern="[0-9]{1,20}" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Escribe el código correlativo del libro, solamente números"></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Codigo </label>
                            </div>
                            <div class="group-material">
                                ...
                                <asp:TextBox ID="txtTitulo" runat="server" class="tooltips-general material-control" placeholder="Escribe aquí el título o nombre del libro" required="" maxlength="70" data-toggle="tooltip" data-placement="top" title="Escribe el título o nombre del libro" ReadOnly="True"></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Título</label>
                            </div>
                            <div class="group-material">
                                ...
                                <asp:TextBox ID="txtAutor" runat="server" class="tooltips-general material-control" placeholder="Escribe aquí el autor del libro" required="" maxlength="70" data-toggle="tooltip" data-placement="top" title="Escribe el nombre del autor del libro" ReadOnly="True"></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Autor</label>
                            </div>
                           ...
                           <div class="group-material">
                                ...
                                <asp:TextBox ID="txtAño" runat="server" class="material-control tooltips-general" placeholder="Escribe aquí el año del libro" required="" pattern="[0-9]{1,4}" maxlength="4" data-toggle="tooltip" data-placement="top" title="Solamente números, sin espacios" ReadOnly="True" ></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Año</label>
                           </div>
                            ...
                            <div class="group-material">
                                ...
                                <asp:TextBox ID="txtStock" runat="server" class="material-control tooltips-general" placeholder="Se mostrarar aquí el stock del articulo" required=" " pattern="[0-9]{1,7}" maxlength="7" data-toggle="tooltip" data-placement="top" title="¿Cuántos libros registraras?" ReadOnly="True" ></asp:TextBox>
                            ...
                            <div class="group-material">
                                ...
                                <asp:TextBox ID="txtUbicacion" runat="server" class="material-control tooltips-general" placeholder="Se mostrara aqui la ubicacion" required=" " pattern="[0-9]{1,7}" maxlength="7" data-toggle="tooltip" data-placement="top" title="¿Donde estara el libro?" ReadOnly="False" ></asp:TextBox>
