            ...
            <div class="full-reset nav-lateral-list-menu">
                <ul class="list-unstyled">
                 ...
                 <%--   <li>
                        ...
                        <ul class="list-unstyled">
                            <li><a href="admin.aspx"><i class="zmdi zmdi-face zmdi-hc-fw"></i>&nbsp;&nbsp; Informacion de usuario</a></li>
                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <div class="group-material">
                            ...
                            <div class="group-material">
                                ...
                                <asp:TextBox ID="txtStock" runat="server" class="material-control tooltips-general" placeholder="Escribe aquí la cantidad de libros que registraras" required=" " pattern="[0-9]{1,7}" maxlength="7" data-toggle="tooltip" data-placement="top" title="¿Cuántos libros registraras?" Width="648px" ></asp:TextBox>
