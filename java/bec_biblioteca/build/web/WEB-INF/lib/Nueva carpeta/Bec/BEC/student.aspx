                ...
                <form autocomplete="off" runat ="server">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <%-- Datos de usuario para ingresar al sistema --%>Datos de usuario<br />
                           <br><br>
                               <div class="group-material">
                                <asp:DropDownList ID="cboUsuario" runat="server" CssClass="material-control tooltip-general"></asp:DropDownList>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label class="auto-style1">Tipo usuario</label>
                            </div>
                            ...
                            <p class="text-center">
                                ...
                                <asp:Button ID="btnGuardar" runat="server" Text="Guardar" CssClass="btn btn-success" OnClick="Button1_Click"/>
                            </p> 
                       </div>
                    </div>
                </form>
