...
public class PrestamoDAO {
    ...
    public List<cl.biblioteca.edm.Prestamo> getList() throws Exception {
        ...
        try 
        {
            ...
            List<cl.biblioteca.edm.Prestamo> lista =  (List<cl.biblioteca.edm.Prestamo>) session.createCriteria(cl.biblioteca.edm.Multimedia.class).list(); 
    ...
    public cl.biblioteca.edm.Prestamo getPrestamoById(int id) throws Exception
    {
         Session session = HibernateUtil.getSessionFactory().openSession();
        try {
            session.beginTransaction();
            ...
            cl.biblioteca.edm.Prestamo tmp = (cl.biblioteca.edm.Prestamo) session.createCriteria(cl.biblioteca.edm.Prestamo.class)
                    .add(Restrictions.eq("prestamoId", id))
                    .uniqueResult();
            session.getTransaction().commit();
            session.close();
            return tmp;
